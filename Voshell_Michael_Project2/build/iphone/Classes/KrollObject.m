...
//@interface Voshell_Michael_Project2Object : NSObject
//@end

@interface Voshell_Michael_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Voshell_Michael_Project2Object class]])
		{
			for (NSString *key in [[(Voshell_Michael_Project2Object*)o modules] allKeys])
			{
