...
@interface Voshell_Michael_Project2Object : KrollCoverageObject {
#else
@interface Voshell_Michael_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Voshell_Michael_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Voshell_Michael_Project2Object *_voshell_michael_project2;
    KrollObject* console;
	BOOL shutdown;
