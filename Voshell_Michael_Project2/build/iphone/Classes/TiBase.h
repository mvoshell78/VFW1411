...
// in simulator we redefine to format for Voshell_Michael_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.voshell_michael_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.voshell_michael_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIVoshell_Michael_Project2NativeItemNone = -1, 
	UIVoshell_Michael_Project2NativeItemSpinner = -2,
	UIVoshell_Michael_Project2NativeItemProgressBar = -3,
	
	UIVoshell_Michael_Project2NativeItemSlider = -4,
	UIVoshell_Michael_Project2NativeItemSwitch = -5,
	UIVoshell_Michael_Project2NativeItemMultiButton = -6,
	UIVoshell_Michael_Project2NativeItemSegmented = -7,
	
	UIVoshell_Michael_Project2NativeItemTextView = -8,
	UIVoshell_Michael_Project2NativeItemTextField = -9,
	UIVoshell_Michael_Project2NativeItemSearchBar = -10,
	
	UIVoshell_Michael_Project2NativeItemPicker = -11,
	UIVoshell_Michael_Project2NativeItemDatePicker = -12,
	
	UIVoshell_Michael_Project2NativeItemInfoLight = -13,
	UIVoshell_Michael_Project2NativeItemInfoDark = -14,
	
	UIVoshell_Michael_Project2NativeItemDisclosure = -15,
	
	UIVoshell_Michael_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Voshell_Michael_Project2 instances of
