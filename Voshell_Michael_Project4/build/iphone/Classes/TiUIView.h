...
/**
 Base class for all Voshell_Michael_Project4 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Voshell_Michael_Project4 view hierarchy (such as wrapped iOS UIViews) was touched.
