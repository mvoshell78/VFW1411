...
@interface Voshell_Michael_Project4Object : KrollCoverageObject {
#else
@interface Voshell_Michael_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Voshell_Michael_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Voshell_Michael_Project4Object *_voshell_michael_project4;
    KrollObject* console;
	BOOL shutdown;
