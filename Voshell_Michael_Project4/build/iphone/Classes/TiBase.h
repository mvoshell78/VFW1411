...
// in simulator we redefine to format for Voshell_Michael_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.voshell_michael_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.voshell_michael_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIVoshell_Michael_Project4NativeItemNone = -1, 
	UIVoshell_Michael_Project4NativeItemSpinner = -2,
	UIVoshell_Michael_Project4NativeItemProgressBar = -3,
	
	UIVoshell_Michael_Project4NativeItemSlider = -4,
	UIVoshell_Michael_Project4NativeItemSwitch = -5,
	UIVoshell_Michael_Project4NativeItemMultiButton = -6,
	UIVoshell_Michael_Project4NativeItemSegmented = -7,
	
	UIVoshell_Michael_Project4NativeItemTextView = -8,
	UIVoshell_Michael_Project4NativeItemTextField = -9,
	UIVoshell_Michael_Project4NativeItemSearchBar = -10,
	
	UIVoshell_Michael_Project4NativeItemPicker = -11,
	UIVoshell_Michael_Project4NativeItemDatePicker = -12,
	
	UIVoshell_Michael_Project4NativeItemInfoLight = -13,
	UIVoshell_Michael_Project4NativeItemInfoDark = -14,
	
	UIVoshell_Michael_Project4NativeItemDisclosure = -15,
	
	UIVoshell_Michael_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Voshell_Michael_Project4 instances of
