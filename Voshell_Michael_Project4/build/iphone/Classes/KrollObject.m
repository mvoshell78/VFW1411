...
//@interface Voshell_Michael_Project4Object : NSObject
//@end

@interface Voshell_Michael_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Voshell_Michael_Project4Object class]])
		{
			for (NSString *key in [[(Voshell_Michael_Project4Object*)o modules] allKeys])
			{
