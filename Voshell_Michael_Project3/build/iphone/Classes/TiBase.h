...
// in simulator we redefine to format for Voshell_Michael_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.voshell_michael_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.voshell_michael_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIVoshell_Michael_Project3NativeItemNone = -1, 
	UIVoshell_Michael_Project3NativeItemSpinner = -2,
	UIVoshell_Michael_Project3NativeItemProgressBar = -3,
	
	UIVoshell_Michael_Project3NativeItemSlider = -4,
	UIVoshell_Michael_Project3NativeItemSwitch = -5,
	UIVoshell_Michael_Project3NativeItemMultiButton = -6,
	UIVoshell_Michael_Project3NativeItemSegmented = -7,
	
	UIVoshell_Michael_Project3NativeItemTextView = -8,
	UIVoshell_Michael_Project3NativeItemTextField = -9,
	UIVoshell_Michael_Project3NativeItemSearchBar = -10,
	
	UIVoshell_Michael_Project3NativeItemPicker = -11,
	UIVoshell_Michael_Project3NativeItemDatePicker = -12,
	
	UIVoshell_Michael_Project3NativeItemInfoLight = -13,
	UIVoshell_Michael_Project3NativeItemInfoDark = -14,
	
	UIVoshell_Michael_Project3NativeItemDisclosure = -15,
	
	UIVoshell_Michael_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Voshell_Michael_Project3 instances of
