...
//@interface Voshell_Michael_Project3Object : NSObject
//@end

@interface Voshell_Michael_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Voshell_Michael_Project3Object class]])
		{
			for (NSString *key in [[(Voshell_Michael_Project3Object*)o modules] allKeys])
			{
