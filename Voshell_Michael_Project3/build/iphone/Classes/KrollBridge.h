...
@interface Voshell_Michael_Project3Object : KrollCoverageObject {
#else
@interface Voshell_Michael_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Voshell_Michael_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Voshell_Michael_Project3Object *_voshell_michael_project3;
    KrollObject* console;
	BOOL shutdown;
