...
// in simulator we redefine to format for Voshell_Michael_project1 Developer console
...
{\
	NSString * exceptionName = [@"org.voshell_michael_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.voshell_michael_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIVoshell_Michael_project1NativeItemNone = -1, 
	UIVoshell_Michael_project1NativeItemSpinner = -2,
	UIVoshell_Michael_project1NativeItemProgressBar = -3,
	
	UIVoshell_Michael_project1NativeItemSlider = -4,
	UIVoshell_Michael_project1NativeItemSwitch = -5,
	UIVoshell_Michael_project1NativeItemMultiButton = -6,
	UIVoshell_Michael_project1NativeItemSegmented = -7,
	
	UIVoshell_Michael_project1NativeItemTextView = -8,
	UIVoshell_Michael_project1NativeItemTextField = -9,
	UIVoshell_Michael_project1NativeItemSearchBar = -10,
	
	UIVoshell_Michael_project1NativeItemPicker = -11,
	UIVoshell_Michael_project1NativeItemDatePicker = -12,
	
	UIVoshell_Michael_project1NativeItemInfoLight = -13,
	UIVoshell_Michael_project1NativeItemInfoDark = -14,
	
	UIVoshell_Michael_project1NativeItemDisclosure = -15,
	
	UIVoshell_Michael_project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Voshell_Michael_project1 instances of
