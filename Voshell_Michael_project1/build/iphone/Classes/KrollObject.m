...
//@interface Voshell_Michael_project1Object : NSObject
//@end

@interface Voshell_Michael_project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Voshell_Michael_project1Object class]])
		{
			for (NSString *key in [[(Voshell_Michael_project1Object*)o modules] allKeys])
			{
