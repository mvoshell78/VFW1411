 ...
 * to send analytic data that can be viewed on the Voshell_Michael_project1 Dashboard.
 *
 * For information on getting started with Voshell_Michael_project1 Platform Services,
