...
//Rare exceptions to indicate a bug in the _voshell_michael_project1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Voshell_Michael_project1 proxies.
 */
