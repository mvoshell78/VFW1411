...
@interface Voshell_Michael_project1Object : KrollCoverageObject {
#else
@interface Voshell_Michael_project1Object : KrollObject {
#endif
@private
...
extern NSString * Voshell_Michael_project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Voshell_Michael_project1Object *_voshell_michael_project1;
    KrollObject* console;
	BOOL shutdown;
